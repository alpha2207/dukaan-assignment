...
const TransactionTable = () => {
  return (
    <table className="w-full ">
      <thead className="text-left bg-[#f7f7f7] w-full gap-10 py-3 px-[10px]">
        <tr className="border-b">
          <th className="py-3 px-[10px] font-normal">Order ID</th>
          <th className="py-3 px-[10px] font-normal">
          ...
          <th className="py-3 px-[10px] text-right font-normal">
            Order amount
          </th>
          <th className="py-3 px-[10px] text-right font-normal">
            Transaction fees
      ...
      <tbody>
        <tr className="border-b">
          <th className="py-3 px-[10px] text-left text-[#146EB4] font-normal">
            <a href="#">#281209</a>
          </th>
          <th className="py-3 px-[10px] text-left  font-normal">
            7 July, 2023
          </th>
          <th className="py-3 px-[10px] text-right font-normal">₹1,278.23</th>
          <th className="py-3 px-[10px] text-right font-normal">₹22</th>
        </tr>
        <tr className="border-b">
          <th className="py-3 px-[10px] text-left text-[#146EB4] font-normal">
            <a href="#">#281209</a>
